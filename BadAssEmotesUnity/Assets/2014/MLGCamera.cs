...
public class MLGCamera : MonoBehaviour
{
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        {
            material.SetFloat("_dr", Mathf.Abs(1.0f - material.GetFloat("_dr")));
        }
        ...
        {
            material.SetFloat("_dg", Mathf.Abs(1.0f - material.GetFloat("_dg")));
        }
        ...
        {
            material.SetFloat("_db", Mathf.Abs(1.0f - material.GetFloat("_db")));
        }
